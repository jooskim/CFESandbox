...
?>
<div data-role="page">
    <!-- start of page--front.tpl.php template -->
...
<header id="top-nav">
    <div class="nav-wrapper">
        <a href="/sandbox/" data-ajax="false" title="Center for Entrepreneurship"><img src="http://www.cfe.umich.edu/sites/all/themes/cfe/css/components/cfe-newlogo.png" border=0></a>
