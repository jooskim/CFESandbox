	...
	<div id="wrapper">
		...
		<div id="page_contents">
          ...
          ?>
				...
				<div id="module3" class="pad pad_left_col">
				<h2>Subscribe to Newsletter</h2>
				<p>Want to stay up to date with news from the Center for Entrepreneurship? <a href="http://eepurl.com/lij3b" target="_blank">Subscribe to our Newsletter</a> for latest news, delivered straight to your inbox!</p>
				</div>
